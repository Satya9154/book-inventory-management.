...
let us discuss the code for Admin Menu function.

Admin Menu
The Admin Menu is designed to show details of users, books, issued books, 
add books, return books, add user, and create or reset the database.
